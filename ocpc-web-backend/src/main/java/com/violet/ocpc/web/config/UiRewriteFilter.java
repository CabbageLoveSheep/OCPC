 ...
 * @Date 2018/9/7 10:15
 */
public class UiRewriteFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain)
	    ...
	    System.out.println("====> UiRewriteFilter doFilter !");
	    
		HttpServletRequest request = (HttpServletRequest) req;
		String servletPath = request.getServletPath();
		String context = request.getContextPath();
		System.out.println("!!!====> urlPatterns :" + urlPatterns + "; servletPath : " + servletPath);
		// 匹配的路径重写
		if (isMatches(urlPatterns, servletPath)) {
		    System.out.println("====> rewriteTo! :" + rewriteTo);
